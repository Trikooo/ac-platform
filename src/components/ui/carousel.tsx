...
type CarouselProps = {
  ...
  buttonPosition?: 1 | 2;
  buttonHover?: boolean;
  hideButtons?: boolean; // New prop for hiding buttons completely
};
    ...
    return (
      <CarouselContext.Provider
        value={{
          ...
          buttonPosition,
          buttonHover,
          hideButtons, // Pass hideButtons to context
        }}
      >
        <div
          ref={ref}
        ...
        >
          {children}
          {!hideButtons && <CarouselPrevious />}
          {!hideButtons && <CarouselNext />}
        </div>
      </CarouselContext.Provider>
    );
  }
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  const { scrollPrev, canScrollPrev, buttonPosition, buttonHover } =
    useCarousel();
...
const CarouselNext = React.forwardRef<
  ...
  React.ComponentProps<typeof Button>
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  const { scrollNext, canScrollNext, buttonPosition, buttonHover } =
    useCarousel();
