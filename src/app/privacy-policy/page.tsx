...
export default function PrivacyPolicy() {
  return (
    <StoreLayout>
    <div className="max-w-4xl mx-10 p-6 mt-10">
      <h1 className="text-6xl font-bold mb-16">Privacy Policy</h1>
      <p className="mb-2">Last updated: October 01, 2024</p>
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li>
          <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Kotek, Draria, Algeria.
        </li>
        <li>
        ...
        <li>
          ...
          facilitate the Service, provide the Service on behalf of the Company,
        ...
        <li>
          <strong>Website</strong> refers to Kotek, accessible from{" "}
          <a href="https://kotek-dz.vercel.app">kotek-dz.vercel.app</a>.
        </li>
        <li>
      ...
      <p className="mb-4">
        Usage Data may include information such as Your Device&lsquo;s Internet
      ...
      <p className="mb-4">
        ...
        already associated with Your Third-Party Social Media Service&lsquo;s account,
      ...
      <p className="mb-4">
        ...
        Company through Your Third-Party Social Media Service&lsquo;s account. If You
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>
          ...
          <p>
            ...
            of user accounts. Without these Cookies, the Service cannot be
            provided.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            ...
            with a more personal experience and to avoid having to re-enter your
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li>
          <strong>To perform a contract:</strong> the development, compliance
      ...
      <ul>
        <li>By email: trikooplays@gmail.com</li>
        <li>
          By visiting this page on our website: kotek-dz.vercel.app/contact
        </li>
      </ul>
    </div>
    </StoreLayout>
